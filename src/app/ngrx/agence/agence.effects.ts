...
import { AgenceActionsType, SaveAgenceActionsSuccess, SaveAgenceActionsError, AgenceActions } from './agence.actions';
  ...
  this.effectActions.pipe(
    ...
    tap((resultat)=>{
      if(resultat.payload == true){
        this.sendErrorNotification(NotificationType.SUCCESS,"La création de l'agence a été effectuée avec succès")
      }else{
        this.sendErrorNotification(NotificationType.ERROR,'Une erreur a été rencontrée')
      }
    })
  ))
  ;
